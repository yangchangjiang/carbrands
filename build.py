...
UI = {
    "en":{"home":"Home","brands":"brands","models":"models","browse_all":"Browse all","founded":"Founded","types":"Types","country":"Country","description":"Description","popular_brands":"Popular Car Brands","view_brand":"View Brand","specs":"Specifications","horsepower":"HP","fuel":"Fuel","seats":"Seats","price":"Price","year":"Year","body":"Body Type""about":"About",},
    "zh-CN":{"home":"首页","brands":"个品牌","models":"款车型","browse_all":"浏览全部","founded":"创立","types":"类型","country":"国家","description":"简介","popular_brands":"热门汽车品牌","view_brand":"查看品牌","specs":"规格","horsepower":"马力","fuel":"燃料","seats":"座位","price":"售价","year":"年份","body":"车身""about":"关于",},
    "ja":{"home":"ホーム","brands":"ブランド","models":"モデル","browse_all":"すべて","founded":"設立","types":"タイプ","country":"国","description":"説明","popular_brands":"人気ブランド","view_brand":"詳細","specs":"スペック","horsepower":"馬力","fuel":"燃料","seats":"座席","price":"価格","year":"年式","body":"ボディ""about":"概要",},
    "ko":{"home":"홈","brands":"브랜드","models":"모델","browse_all":"전체","founded":"설립","types":"유형","country":"국가","description":"설명","popular_brands":"인기 브랜드","view_brand":"보기","specs":"제원","horsepower":"마력","fuel":"연료","seats":"좌석","price":"가격","year":"연식","body":"차체""about":"소개",},
    "es":{"home":"Inicio","brands":"marcas","models":"modelos","browse_all":"Explorar","founded":"Fundado","types":"Tipos","country":"País","description":"Descripción","popular_brands":"Marcas Populares","view_brand":"Ver Marca","specs":"Especificaciones","horsepower":"CV","fuel":"Combustible","seats":"Asientos","price":"Precio","year":"Año","body":"Carrocería""about":"Acerca",},
    "pt":{"home":"Início","brands":"marcas","models":"modelos","browse_all":"Explorar","founded":"Fundado","types":"Tipos","country":"País","description":"Descrição","popular_brands":"Marcas Populares","view_brand":"Ver","specs":"Especificações","horsepower":"CV","fuel":"Combustível","seats":"Assentos","price":"Preço","year":"Ano","body":"Categoria""about":"Sobre",},
    "fr":{"home":"Accueil","brands":"marques","models":"modèles","browse_all":"Parcourir","founded":"Fondé","types":"Types","country":"Pays","description":"Description","popular_brands":"Marques Populaires","view_brand":"Voir","specs":"Spécifications","horsepower":"CV","fuel":"Carburant","seats":"Places","price":"Prix","year":"Année","body":"Carrosserie""about":"À propos",},
    "de":{"home":"Start","brands":"Marken","models":"Modelle","browse_all":"Alle","founded":"Gegründet","types":"Typen","country":"Land","description":"Beschreibung","popular_brands":"Beliebte Marken","view_brand":"Details","specs":"Technische Daten","horsepower":"PS","fuel":"Kraftstoff","seats":"Sitze","price":"Preis","year":"Jahr","body":"Karosserie""about":"Über",},
    "ar":{"home":"الرئيسية","brands":"علامة","models":"موديل","browse_all":"تصفح","founded":"تأسست","types":"أنواع","country":"بلد","description":"وصف","popular_brands":"علامات مشهورة","view_brand":"تفاصيل","specs":"المواصفات","horsepower":"حصان","fuel":"الوقود","seats":"مقاعد","price":"السعر","year":"السنة","body":"نوع الهيكل""about":"حول",},
    "hi":{"home":"होम","brands":"ब्रांड","models":"मॉडल","browse_all":"सभी","founded":"स्थापित","types":"प्रकार","country":"देश","description":"विवरण","popular_brands":"लोकप्रिय ब्रांड","view_brand":"देखें","specs":"स्पेक्स","horsepower":"एचपी","fuel":"ईंधन","seats":"सीटें","price":"कीमत","year":"वर्ष","body":"बॉडी""about":"बारे में",},
    "th":{"home":"หน้าแรก","brands":"แบรนด์","models":"รุ่น","browse_all":"ทั้งหมด","founded":"ก่อตั้ง","types":"ประเภท","country":"ประเทศ","description":"คำอธิบาย","popular_brands":"แบรนด์ยอดนิยม","view_brand":"ดู","specs":"สเปก","horsepower":"แรงม้า","fuel":"เชื้อเพลิง","seats":"ที่นั่ง","price":"ราคา","year":"ปี","body":"ตัวถัง""about":"เกี่ยวกับ",},
    "vi":{"home":"Trang chủ","brands":"thương hiệu","models":"mẫu xe","browse_all":"Tất cả","founded":"Thành lập","types":"Loại","country":"Quốc gia","description":"Mô tả","popular_brands":"Thương Hiệu Phổ Biến","view_brand":"Xem","specs":"Thông số","horsepower":"Mã lực","fuel":"Nhiên liệu","seats":"Chỗ","price":"Giá","year":"Năm","body":"Kiểu""about":"Giới thiệu",},
    "id":{"home":"Beranda","brands":"merek","models":"model","browse_all":"Semua","founded":"Didirikan","types":"Tipe","country":"Negara","description":"Deskripsi","popular_brands":"Merek Populer","view_brand":"Lihat","specs":"Spesifikasi","horsepower":"HP","fuel":"Bahan Bakar","seats":"Kursi","price":"Harga","year":"Tahun","body":"Tipe""about":"Tentang",},
    "ru":{"home":"Главная","brands":"брендов","models":"моделей","browse_all":"Все","founded":"Основан","types":"Типы","country":"Страна","description":"Описание","popular_brands":"Популярные Бренды","view_brand":"Подробнее","specs":"Характеристики","horsepower":"Л.С.","fuel":"Топливо","seats":"Мест","price":"Цена","year":"Год","body":"Кузов""about":"О нас",},
}
...
COUNTRY_TR = {
    "zh-CN":{"Japan":"日本","Germany":"德国","United States":"美国","South Korea":"韩国","China":"中国","France":"法国","Italy":"意大利","Sweden":"瑞典","United Kingdom":"英国","India":"印度","Malaysia":"马来西亚","Spain":"西班牙","Czech Republic":"捷克","Romania":"罗马尼亚","Russia":"俄罗斯","Vietnam":"越南""about":"关于",},
    "ja":{"Japan":"日本","Germany":"ドイツ","United States":"アメリカ","South Korea":"韓国","China":"中国","France":"フランス","Italy":"イタリア","Sweden":"スウェーデン","United Kingdom":"イギリス","India":"インド","Russia":"ロシア","Vietnam":"ベトナム""about":"概要",},
    "ko":{"Japan":"일본","Germany":"독일","United States":"미국","South Korea":"한국","China":"중국","France":"프랑스","Italy":"이탈리아","Sweden":"스웨덴","United Kingdom":"영국","India":"인도","Russia":"러시아""about":"소개",},
}
...
def build_car_page(c, lang):
    ...
    return f'<!DOCTYPE html><html lang="{lang}"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{c["model"]} {c["brand"]} — {ui["horsepower"]}, {ui["fuel"]}, {ui["price"]}, {ui["year"]} {ui["specs"]} | {DOMAIN}</title><meta name="description" content="{seo_desc}"><meta name="keywords" content="{c["model"]}, {c["model"]} specs, {c["model"]} {c["brand"]}, {c["model"]} horsepower, {c["model"]} price, {c["model"]} fuel economy, {c["model"]} {c["year"]}, {c["model"]} dimensions, {c["model"]} review, {c["brand"]} {c["model"]} specs, {c["model"]} 0-60""><style>{CSS}</style>{ADS}{hreflang}</head><body><header><nav><span class="logo">🏎️ {DOMAIN}</span><a href="/{lp}">{ui["home"]}</a><a href="/{lp}brand/{brand_slug}">{c["brand"]}</a>{DROPDOWN}</nav></header><div class="car-detail-hero"><div style="margin-bottom:12px">{car_svg}</div><div class="car-name">{model_name}</div><div class="car-brand">{c["brand"]} · {c["body"]}</div></div><div class="car-specs-card"><div class="car-specs-grid"><div class="car-spec"><div class="sv">{c["horsepower"]}</div><div class="sl">{ui["horsepower"]}</div></div><div class="car-spec"><div class="sv">{c["fuel"]}</div><div class="sl">{ui["fuel"]}</div></div><div class="car-spec"><div class="sv">{c["seats"]}</div><div class="sl">{ui["seats"]}</div></div><div class="car-spec"><div class="sv">{c["price"]}</div><div class="sl">{ui["price"]}</div></div><div class="car-spec"><div class="sv">{c["year"]}</div><div class="sl">{ui["year"]}</div></div><div class="car-spec"><div class="sv">{c["body"]}</div><div class="sl">{ui["body"]}</div></div></div></div><footer>&copy; 2026 {DOMAIN}</footer><div class="cookie-consent"><span>{cookie[0]}</span><div class="cookie-btns"><button class="cookie-accent" onclick="this.parentElement.parentElement.style.display=\'none\'" style="background:var(--accent);color:white;border:none;padding:8px 24px;border-radius:4px;cursor:pointer;font-weight:600">{cookie[1]}</button><button class="cookie-decline" onclick="this.parentElement.parentElement.style.display=\'none\'" style="background:#3f3f46;color:white;border:none;padding:8px 24px;border-radius:4px;cursor:pointer">{cookie[2]}</button></div></div>{GOLANG}{BAIDU}{bc}</body></html>'


# Fuel type translations
FUEL_TR = {
    "zh-CN": {"Gasoline":"汽油","Hybrid":"混动","Electric":"电动","Gasoline/Hybrid":"汽油/混动","Gasoline/Electric":"汽油/电动","Electric/Hybrid":"电动/混动""about":"关于",},
    "ja": {"Gasoline":"ガソリン","Hybrid":"ハイブリッド","Electric":"電気","Gasoline/Hybrid":"ガソリン/HV""about":"概要",},
    "ko": {"Gasoline":"가솔린","Hybrid":"하이브리드","Electric":"전기""about":"소개",},
    "es": {"Gasoline":"Gasolina","Hybrid":"Híbrido","Electric":"Eléctrico""about":"Acerca",},
    "pt": {"Gasoline":"Gasolina","Hybrid":"Híbrido","Electric":"Elétrico""about":"Sobre",},
    "fr": {"Gasoline":"Essence","Hybrid":"Hybride","Electric":"Électrique""about":"À propos",},
    "de": {"Gasoline":"Benzin","Hybrid":"Hybrid","Electric":"Elektro""about":"Über",},
    "ar": {"Gasoline":"بنزين","Hybrid":"هايبرد","Electric":"كهرباء""about":"حول",},
    "ru": {"Gasoline":"Бензин","Hybrid":"Гибрид","Electric":"Электро""about":"О нас",},
}
...
def build_brand_page(b, lang):
    ...
    article_schema = f'<script type="application/ld+json">{{"@context":"https://schema.org","@type":"Article","headline":"{b["name"]} Car Models & Specs","description":"{b["description"]}","author":{{"@type":"Organization","name":"{DOMAIN}"}}}}</script>'
    article_schema = f'<script type="application/ld+json">{{"@context":"https://schema.org","@type":"Article","headline":"{b["name"]} Car Models & Specs","description":"{b["description"]}","author":{{"@type":"Organization","name":"{DOMAIN}"}}}}</script>'
    return f'<!DOCTYPE html><html lang="{lang}"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{b["name"]} {ui["brands"]} — {len(b_cars)} {ui["models"]}, {ui["founded"]} {b["founded"]}, {b["types"]} | {DOMAIN}</title><meta name="description" content="{b["name"]} {ui["brands"]} — {len(b_cars)} {ui["models"]} with specs, pricing, reviews. {ui["founded"]} {b["founded"]}, {ui["country"]} {loc}. Types: {b["types"]}. {b["description"]} Find {b["name"]} car models, specs, horsepower, fuel efficiency."><meta name="keywords" content="{b["name"]}, {b["name"]} models, {b["name"]} cars, {b["name"]} specs, {b["name"]} price, {b["name"]} review, {b["name"]} {b["country"]}, {b["name"]} 2024, {b["name"]} lineup"><style>{CSS}</style>{ADS}{hreflang}</head><body><header><nav><span class="logo">🏎️ {DOMAIN}</span><a href="/{lp}">{ui["home"]}</a>{DROPDOWN}</nav></header><div class="detail-hero"><div class="brand-name-lg">{html.escape(b["name"])}</div><div class="brand-sub">{loc} · {ui["founded"]} {b["founded"]} · {len(b_cars)} {ui["models"]}</div></div><div class="model-grid">{model_cards}</div><footer>&copy; 2026 {DOMAIN}</footer><div class="cookie-consent"><span>{cookie[0]}</span><div class="cookie-btns"><button class="cookie-accent" onclick="this.parentElement.parentElement.style.display=\'none\'" style="background:var(--accent);color:white;border:none;padding:8px 24px;border-radius:4px;cursor:pointer;font-weight:600">{cookie[1]}</button><button class="cookie-decline" onclick="this.parentElement.parentElement.style.display=\'none\'" style="background:#3f3f46;color:white;border:none;padding:8px 24px;border-radius:4px;cursor:pointer">{cookie[2]}</button></div></div>{GOLANG}{BAIDU}{faq}{bc}{article_schema}</body></html>'
