...
def build_brand_page(b, lang):
    ...
    model_cards = ""
    for c in b_cars:
        model_cards += f'<div class="model-card"><div class="model-name">{html.escape(c["model"])}</div><div class="model-specs"><div><span class="spec-label">{ui["horsepower"]}</span><br><span class="spec-value">{c["horsepower"]}</span></div><div><span class="spec-label">{ui["fuel"]}</span><br><span class="spec-value">{c["fuel"]}</span></div><div><span class="spec-label">{ui["seats"]}</span><br><span class="spec-value">{c["seats"]}</span></div><div><span class="spec-label">{ui["price"]}</span><br><span class="spec-value">{c["price"]}</span></div></div></div>\n'
